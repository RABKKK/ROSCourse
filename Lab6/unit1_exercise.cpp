...
int main(int argc, char **argv) {
  ...
  //Define an object of class RosbotMove initializing the variables using the constructor
  //Run the function in the class that makes the robot move and avoid the obstacle
}
